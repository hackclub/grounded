  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-300 px-6 py-12 space-y-12">
      <section className="max-w-4xl mx-auto space-y-4 text-center">
        ...
        <ul className="list-disc list-inside text-slate-400 text-left max-w-md mx-auto">
        ...
        <h1 className="text-4xl font-bold text-emerald-400">How to get approved</h1>
        <p className="text-slate-400">
      ...
      <div>
        ...
        <p className="text-xl font-semibold mb-2">If you rather not manage a journal, check out <code className="bg-emerald-500/20 px-1 rounded text-emerald-400">#Groundplane</code> on the sidebar</p>
...
**Total time spent: 2h**`}</pre>
      ...
      <div>
        <h3 className="text-xl font-semibold mb-2">3. Design your project</h3>
        <p>
          Look at the available parts below and start your project. A typical project will have a 3d model and if it is possible to, make a <a
            href="https://hackclub.com/slack/?event=grounded"
            target="_blank"
            rel="noreferrer"
            className="text-emerald-400 underline"
        ...
        <p>Just remember to update your journal throught your entire project.</p>
      </div>
      ...
      <h3 className="text-xl font-semibold mb-2">3. Submit your project</h3>
      <p>Once your project is fully designed, make sure you have a <code className="bg-emerald-700 px-1 rounded">JOURNAL.md</code>, the files for your project and any Wokwi links to your simulated circuit in your project. Once that is all good, fill out the form below to submit your project:</p>
      <section className="space-y-4 pt-5">
        <p className="text-slate-300">Submit your project through this form:</p>
        <a href="https://forms.hackclub.com/grounded-hardware" target="_blank" className="inline-block bg-emerald-500/20 px-4 py-2 rounded-md text-emerald-400 font-semibold hover:bg-emerald-500/30 transition">Grounded Hardware Grant</a>
      </section>
    </main>
  );
}
