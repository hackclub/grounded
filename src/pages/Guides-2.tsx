...
import { BookOpen, ArrowLeft, ChevronRight, ChevronDown, ExternalLink, Zap, Shield, Download, Upload, Settings, CreditCard, Eye, Wrench } from 'lucide-react';
          ...
          <div className="p-6 border-b border-slate-700/50">
            <Link to="/" className="flex items-center space-x-3 group cursor-pointer">
              ...
              <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg relative">
                ...
                <ArrowLeft className="w-5 h-5 text-white absolute inset-0 opacity-0 transition-opacity duration-150 group-hover:opacity-100" />
              </div>
