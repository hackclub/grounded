...
import GrantOptions from '@/components/GrantOptions';
          ...
          <section className="min-h-[calc(100vh-88px)] flex flex-col justify-center py-0 px-6 text-center">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 mt-16">
                ...
                <Link href="https://github.com/hackclub/OnBoard/tree/main/projects" target="_blank">
          ...
          <section className='p-12 pl-12 pr-12'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="bg-gray-900/70 border-blue-700/50 hover:border-blue-500 transition-all duration-300 group hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 p-4">
                ...
                <p className="text-gray-300 mt-2">You can not submit the same project to two programs. Summer of making is allowed!</p>
              </Card>
              <Card className="bg-gray-900/70 border-blue-700/50 hover:border-blue-500 transition-all duration-300 group hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 p-4">
              ...
              <Card className="bg-gray-900/70 border-blue-700/50 hover:border-blue-500 transition-all duration-300 group hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20 p-4">
                ...
                <p className="text-gray-300 mt-2">The current end date for the grant program is for September 30th however this may be subject to changes.</p>
              </Card>
            </div>
