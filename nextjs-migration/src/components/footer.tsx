...
// You'll need to install these or replace with your preferred styling solution
// npm install @emotion/styled @emotion/react @theme-ui/core
...
// Base component styles - you can convert this to CSS modules or Tailwind if preferred
const baseStyles = (dark) => ({
  ...
  backgroundSize: dark ? `${theme.space[4]} ${theme.space[4]}` : 'auto',
  '@media print': {
    display: 'none'
  }
})
...
// Icon component - you'll need to replace this with your icon system

const Service = ({ href, name = '', target = '_blank', ...props }) => (
  <a
    target={target}
    rel="noopener me"
    href={href}
    title={`Hack Club on ${name}`}
    style={{
      lineHeight: 0,
      marginBottom: 0,
    ...
    onMouseEnter={(e) => e.target.style.transform = 'scale(1.125)'}
...
const Footer = ({
  ...
  return (
    <footer
      style={{
        ...baseStyles(dark),
        color: dark ? theme.colors.muted : theme.colors.slate,
        paddingTop: '32px',
        paddingBottom: '32px',
        textAlign: 'left'
      }}
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <a href="https://hackclub.com/pizza" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted,
                transition: '0.125s color ease-in-out'
              }}>
              ...
              <a href="https://events.hackclub.com/" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted,
                transition: '0.125s color ease-in-out'
              }}>
              ...
              <a href="https://jams.hackclub.com/" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted,
                transition: '0.125s color ease-in-out'
              }}>
              ...
              <a href="https://toolbox.hackclub.com/" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted,
                transition: '0.125s color ease-in-out'
              }}>
              ...
              <a href="https://directory.hackclub.com/" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted,
                transition: '0.125s color ease-in-out'
              }}>
              ...
              <a href="https://hackclub.com/conduct/" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted,
                transition: '0.125s color ease-in-out'
              }}>
          ...
          <div>
            ...
            <div style={{ marginTop: '0.5rem', marginBottom: '0.5rem' }}>
              <a href="tel:1-855-625-HACK" style={{ 
                textDecoration: 'none', 
                color: theme.colors.muted 
              }}>
                1-855-625-HACK
